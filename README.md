...
a small set of Lotka related functions 
...
Download the [zip ball](https://github.com/timriffe/Lotka/zipball/master) or [tar ball](https://github.com/timriffe/Lotka/tarball/master), decompress and run `R CMD INSTALL` on it in the terminal command line, or use the **devtools** package to install the development version:

```r
# install.packages("devtools")

library(devtools)
install_github("Lotka", subdir = "Lotka", username = "timriffe")
```
